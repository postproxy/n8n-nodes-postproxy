...
### Fixed
- Removed `prepare` lifecycle script from package.json (not allowed for n8n community nodes)
...
### Changed
- Extended httpRequestWithAuthentication to listSearch and loadOptions methods for consistency
...
### Fixed
- Removed deprecated helper method in credential test
